 ...
 * 1. Use the modulo(%) operator and the terary operator(?) to calculate the correct encryption/decryption key.
 ...
 * 5. Pass true to the last parameter, decrypt, to decrypt an encryptrd string.
 */
